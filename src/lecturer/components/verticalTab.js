    ...
    <div className={classes.root}>
      ...
      <div >
        ...
        >
          ...
          <Tab fullWidth style = {{ height:'80px',maxWidth:'500px', textTransform: 'none', fontSize:18 }} label={<div style={{marginLeft:'30px', color: '#AD59D4'}}><CastForEducationIcon color='action' style={{fontSize:"50px",verticalAlign:'middle'}} /> Activities</div>} {...a11yProps(2)} />
